/* TronoPDF - Signature Resize v2 | worldwide simple: exact px + KB, advanced tucked */
(function(){
...
document.getElementById('srGo').onclick=function(){
 if(!img){return;}
 var W=Math.max(10,parseInt(elW.value)||300),H=Math.max(10,parseInt(elH.value)||100);
 var c=document.createElement('canvas');c.width=W;c.height=H;
 var x=c.getContext('2d');
 if(elFmt.value==='jpg'){x.fillStyle='#fff';x.fillRect(0,0,W,H);}
 ...
 if(elKb.checked&&elFmt.value==='jpg'){
  var target=(parseFloat(elKbVal.value)||20)*1024;
